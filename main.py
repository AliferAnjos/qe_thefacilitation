...
#Last Dreamer - Label
ld = Label(text="LASTDREAMER.COM", bg="#000000", fg="#ffffff", font="Consolas")
ld.place(x=205, y=550)
...
facilitate = Button(text="FACILITATE", bg="#000000", fg="#cd2d2d", justify="center", font="Consolas")
facilitate.place(x=218, y=280)

# delta_entry = Entry(text=int(delta()), state="readonly", justify="center")
